...
import subprocess
details = {}
with open("credentialsuser.txt") as file:
    lis = file.read().split(" -|- ")
...
columns = ('book_id', 'book_name', 'author','genre')
...
suggestedButton = tk.Button(
    show,
    text="Suggested",
    font=('Manrope Bold', 15),
    background="#303030",
    foreground="#eaeaea",
    command=lambda: subprocess.call('python suggested.py'),
    cursor='dot',
    height=2,
    width=15,
    borderwidth=0,
